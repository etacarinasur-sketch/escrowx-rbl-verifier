...
const AUTHORIZED_SENDER =
  "0xd816a54f2d0edceca74062721b7f93dd56e182c6";

const DEPOSIT_ADDRESS =
  "0x9e53bba89d77410298aa5a6ce23383244012c8c3";
...
async function verifyRubiTransaction(amount, txHash) {
  ...
  try {
    ...
    if (chainFrom !== AUTHORIZED_SENDER.toLowerCase()) {
      return { ok: false, error: "Sender wallet does not match the authorized wallet." };
    }
